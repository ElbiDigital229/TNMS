...
assetCategoryRoutes.post(
  "/",
  requirePermission(PERMISSIONS.SETTINGS.ASSET_CATEGORIES_MANAGE),
...
assetCategoryRoutes.patch(
  "/:id/deactivate",
  requirePermission(PERMISSIONS.SETTINGS.ASSET_CATEGORIES_MANAGE),
  validate({ params: uuidIdParamSchema }),
  assetCategoryController.deactivate,
);
assetCategoryRoutes.patch(
  "/:id/activate",
  requirePermission(PERMISSIONS.SETTINGS.ASSET_CATEGORIES_MANAGE),
  validate({ params: uuidIdParamSchema }),
  assetCategoryController.activate,
);
