  ...
  return (
    <div>
      ...
      <div className="mb-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
        <StatCard to="/tickets?overdue=1" icon={<AlertTriangle size={18} />} iconBg="bg-red-50 text-red-600" label="Overdue Tickets" value={stats.tickets.overdue} valueColor="text-red-600" />
